package com.serverMonitor.config.rest.resources;
...
public enum Statuses {
    ...
    StockNotConnected(46), NewsAnalyzerSettingsNotFound(47), PortfolioManagerIncorrectResponse(48), TradeForecastNotFound(49), PairNotSupported(50),
