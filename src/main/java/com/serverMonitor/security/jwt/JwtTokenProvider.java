...
//        try {
//            return  userService.findByEmail(getEmail(bearerToken)) != null
//                    ? userService.findByEmail(getEmail(bearerToken)) : userService.getUserByApiToken(bearerToken);
//        } catch (ExpiredJwtException e) {
//            return userService.getUserByApiToken(bearerToken);
//        }
//    }
