package com.serverMonitor.utils.requests;
...
public class RequestHelper {
    ...
    public static HttpResponse<String>  GET_Request(String url, String... headers) {
        try {
...
//            return send.statusCode();
    ...
    public static HttpResponse<String> POST_Request(String url, String params, String... headers) {
        try {
